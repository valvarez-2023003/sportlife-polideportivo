...
BEGIN
    INSERT INTO Users(
        name, lastname, email, user, password, role, phone, id_user
    )
    VALUES (
        name_p, lastname_p, email_p, user_p, password_p, role_p, NULL, UUID()
    );
END $$
...
BEGIN
    ...
    VALUES (
        name_p, lastname_p, email_p, user_p, password_p, 'User', phone_p, UUID()
    );
END $$
